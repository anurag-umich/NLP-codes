...
class LogisticRegression:
    ...
    def __init__(self, dimension, num_classes):
       ...
       # raise NotImplementedError
        ...
        self.gradient_b = T.grad(cost=self.cost, wrt= self.b)

        self.gradient_W = T.grad(cost=self.cost, wrt=self.W)
      

        self.updates = [(self.W, self.W - learning_rate * self.gradient_W),
